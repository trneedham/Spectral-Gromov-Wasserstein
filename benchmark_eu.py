...
mutual_info = process_sgwl_eu(cost,database,num_nodes,num_partitions);
end = time.time()
...
mis = []
rt = []
ts = [7+12/19] #np.linspace(7,10,20)
for t in ts:
    start = time.time()
...
with open('res_benchmark_eu.txt', 'w') as outfile:
